...
#If you have CouchRest:
  ...
  couch_env = TinkitNodeFactory.env_formatter("couchrest", couch_class_id, user_id, cr_path, cr_host)
  
  #building the filesystem environment
  filesys_env = TinkitNodeFactory.env_formatter("filesystem", file_class_id, user_id, fs_path)
  #p couch_env
  
  #building an environment for AWS (Simple DB for data, S3 for attachments)
  sdbs3_env = TinkitNodeFactory.env_formatter("sdb_s3", sdbs3_class_id, user_id, sdbs3_path)
